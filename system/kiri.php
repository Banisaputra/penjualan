...
if ($_GET['module'] == 'home') {
    echo "
	<h3>Selamat datang ".$_SESSION['namalengkap']."<span style='float:right'>
	<a href='media.php?module=home&grafik=kategori'>
	<input type='button' value='Grafik Kategori'></a>
	<a href='media.php?module=home&grafik=bulanan'>
	<input type='button' value='Grafik Bulanan'></a>
	<a href='media.php?module=home&grafik=tahunan'>
	<input type='button' value='Grafik Tahunan'></a>
	</h3>";
    ...
    $sql = mysqli_query($conn, "SELECT * FROM statis WHERE halaman='home'");
    $r = mysqli_fetch_array($sql);
    echo "
	<h3>Edit Data Home Page</h3><br>
		  <table width=100%>
    ...
    if (isset($_POST['submit'])) {
        mysqli_query($conn, "UPDATE statis SET judul='$_POST[judul]', detail='$_POST[detail]' where halaman='home'");
...
echo "<input type='hidden' name='module' value='keranjang'>
    ...
    while ($r = mysql_fetch_array($sql)) {
        ...
        $harga = format_rupiah($r[harga]);
        if (($no % 2) == 0) {$warna = "#E1E1E1";} else { $warna = "#ffffff";}
